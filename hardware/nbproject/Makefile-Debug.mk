...
# CC Compiler Flags
CCFLAGS=-m64 -O0 -ggdb3 -Woverloaded-virtual -Wunused -Wtautological-compare -Wshadow -Wconversion -Wmissing-field-initializers -Wno-multichar
CXXFLAGS=-m64 -O0 -ggdb3 -Woverloaded-virtual -Wunused -Wtautological-compare -Wshadow -Wconversion -Wmissing-field-initializers -Wno-multichar
...
${TESTDIR}/tests/PinTest.o: tests/PinTest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -I. -std=c++14 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/PinTest.o tests/PinTest.cpp


${TESTDIR}/tests/PinTestRunner.o: tests/PinTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -I. -std=c++14 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/PinTestRunner.o tests/PinTestRunner.cpp
